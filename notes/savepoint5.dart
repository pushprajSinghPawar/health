                              ...
                              child: SingleChildScrollView(
                                ...
                                child: DataTable(
                                    ...
                                    columns: [
                                      ...
                                      DataColumn(
                                          label: Text('Carbohydrate content')),
                                      DataColumn(label: Text('Fat Content')),
                                      DataColumn(label: Text('Sugar content')),
                                      DataColumn(
                                          label: Text('Cholestrol content')),
                                    ],
                                    rows: info
                                        .map((e) => DataRow(cells: [
                                              DataCell(
                                                  Text(e['name'].toString())),
                                              DataCell(Text(e['serving_size_g']
                                                  .toString())),
                                              DataCell(Text(
                                                  e['calories'].toString())),
                                              DataCell(Text(
                                                  e['protein_g'].toString())),
                                              DataCell(Text(
                                                  e['carbohydrates_total_g']
                                                      .toString())),
                                              DataCell(Text(
                                                  e['fat_total_g'].toString())),
                                              DataCell(Text(
                                                  e['sugar_g'].toString())),
                                              DataCell(Text(e['cholesterol_mg']
                                                  .toString())),
                                            ]))
                                        .toList()),
                              ),
